...
define('CountdownControls', () => {
    ...
    describe('render', ()=>{
        it('should render pause when started', ()=>{
            var control = TestUtils.renderIntoDocument(<CountdownControl controlStatus="started"/>);
        ...
        it('should render continue when paused', ()=>{
            var control = TestUtils.renderIntoDocument(<CountdownControl controlStatus="paused"/>);
            var $el = $(ReactDOM.findDOMNode(control));
